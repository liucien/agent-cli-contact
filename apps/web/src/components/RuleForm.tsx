  ...
  return (
    <div className="rule-form">
      <div className="row-f">
        ...
        <span style={{ color: 'var(--dim)' }}>进入</span>
        <select value={trigger} onChange={(e) => setTrigger(e.target.value as TriggerState)}>
          <option value="done">done</option>
          <option value="blocked">blocked</option>
          <option value="idle">idle</option>
        </select>
        <span style={{ color: 'var(--dim)' }}>后 →</span>
